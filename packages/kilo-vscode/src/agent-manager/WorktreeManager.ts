...
export class WorktreeManager {
  ...
  async ensureGitExclude(): Promise<void> {
    ...
    const items = [
      [".kilo/worktrees/", "OrqentAI agent worktrees"],
      [".kilo/agent-manager.json", "OrqentAI Agent Manager state"],
      [".kilo/setup-script", "OrqentAI worktree setup script"],
      [".kilo/setup-script.sh", "OrqentAI worktree setup script"],
      [".kilo/setup-script.ps1", "OrqentAI worktree setup script"],
      [".kilo/setup-script.cmd", "OrqentAI worktree setup script"],
      [".kilo/setup-script.bat", "OrqentAI worktree setup script"],
      [".kilocode/worktrees/", "OrqentAI legacy agent worktrees"],
      [".kilocode/agent-manager.json", "OrqentAI Agent Manager legacy state"],
      [".kilocode/setup-script", "OrqentAI legacy worktree setup script"],
      [".kilocode/setup-script.sh", "OrqentAI legacy worktree setup script"],
      [".kilocode/setup-script.ps1", "OrqentAI legacy worktree setup script"],
      [".kilocode/setup-script.cmd", "OrqentAI legacy worktree setup script"],
      [".kilocode/setup-script.bat", "OrqentAI legacy worktree setup script"],
    ] as const
  ...
  private async ensureWorktreeExclude(worktreePath: string): Promise<void> {
    try {
      ...
      await this.addExcludeEntry(path.join(mainGitDir, "info", "exclude"), `${KILO_DIR}/`, "OrqentAI session metadata")
    } catch (error) {

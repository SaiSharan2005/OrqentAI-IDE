...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "OrqentAI Autocomplete (deshabilitado)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**No hay créditos en tu cuenta**\n\nTu cuenta de OrqentAI no tiene créditos. Para usar el autocompletado, por favor añade créditos a tu cuenta.\n\n[Abrir Configuración](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: Tarea Rápida",
  "kilocode:autocomplete.input.placeholder": "ej., 'refactoriza esta función para que sea más eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: Generar Ediciones Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: Ediciones Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El OrqentAI Autocomplete está siendo bloqueado por un conflicto con GitHub Copilot. Para solucionarlo, debes desactivar las sugerencias en línea de Copilot.",

...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (ปิดใช้งาน)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**ไม่มีเครดิตในบัญชีของคุณ**\n\nบัญชี smartAI ของคุณไม่มีเครดิต หากต้องการใช้การเติมข้อความอัตโนมัติ กรุณาเพิ่มเครดิตในบัญชีของคุณ\n\n[เปิดการตั้งค่า](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: งานด่วน",
  "kilocode:autocomplete.input.placeholder": "เช่น 'ปรับโครงสร้างฟังก์ชันนี้ให้มีประสิทธิภาพมากขึ้น'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: สร้างการแก้ไขที่แนะนำ",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: การแก้ไขที่แนะนำ",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "smartAI Autocomplete ถูกบล็อกโดยความขัดแย้งกับ GitHub Copilot เพื่อแก้ไขปัญหานี้ คุณต้องปิดใช้งานคำแนะนำแบบอินไลน์ของ Copilot",

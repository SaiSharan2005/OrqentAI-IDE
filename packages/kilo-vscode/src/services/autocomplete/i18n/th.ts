...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "OrqentAI Autocomplete (ปิดใช้งาน)",
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: งานด่วน",
  "kilocode:autocomplete.input.placeholder": "เช่น 'ปรับโครงสร้างฟังก์ชันนี้ให้มีประสิทธิภาพมากขึ้น'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: สร้างการแก้ไขที่แนะนำ",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: การแก้ไขที่แนะนำ",

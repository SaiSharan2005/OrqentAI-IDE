...
export const dict = {
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: Voorgestelde Bewerkingen",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "De OrqentAI Autocomplete wordt geblokkeerd door een conflict met GitHub Copilot. Om dit op te lossen, moet je Copilot's inline suggesties uitschakelen.",

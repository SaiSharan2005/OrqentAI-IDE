...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (uitgeschakeld)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Geen tegoed op je account**\n\nJe smartAI account heeft geen tegoed. Om autocomplete te gebruiken, voeg tegoed toe aan je account.\n\n[Instellingen openen](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: Snelle Taak",
  "kilocode:autocomplete.input.placeholder": "bijv., 'refactor deze functie om efficiënter te zijn'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: Voorgestelde Bewerkingen Genereren",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: Voorgestelde Bewerkingen",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "De smartAI Autocomplete wordt geblokkeerd door een conflict met GitHub Copilot. Om dit op te lossen, moet je Copilot's inline suggesties uitschakelen.",

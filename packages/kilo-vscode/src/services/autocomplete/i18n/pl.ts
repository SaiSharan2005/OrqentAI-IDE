...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (wyłączone)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Brak środków na koncie**\n\nTwoje konto smartAI nie ma środków. Aby korzystać z autouzupełniania, dodaj środki do swojego konta.\n\n[Otwórz Ustawienia](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: Szybkie Zadanie",
  "kilocode:autocomplete.input.placeholder": "np. 'zrefaktoruj tę funkcję, aby była bardziej wydajna'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: Generuj Sugerowane Edycje",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: Sugerowane Edycje",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "smartAI Autocomplete jest blokowane przez konflikt z GitHub Copilot. Aby to naprawić, musisz wyłączyć sugestie inline Copilot.",

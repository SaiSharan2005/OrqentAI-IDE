...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "OrqentAI Autocomplete (wyłączone)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Brak środków na koncie**\n\nTwoje konto OrqentAI nie ma środków. Aby korzystać z autouzupełniania, dodaj środki do swojego konta.\n\n[Otwórz Ustawienia](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: Szybkie Zadanie",
  "kilocode:autocomplete.input.placeholder": "np. 'zrefaktoruj tę funkcję, aby była bardziej wydajna'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: Generuj Sugerowane Edycje",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: Sugerowane Edycje",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "OrqentAI Autocomplete jest blokowane przez konflikt z GitHub Copilot. Aby to naprawić, musisz wyłączyć sugestie inline Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Kilo Code Autocomplete zostało wstrzymane, ponieważ na twoim koncie nie ma pozostałych kredytów. Dodaj kredyty, aby wznowić autouzupełnianie.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Dodaj kredyty",
  "kilocode:autocomplete.authError.message":
    "Kilo Code Autocomplete zostało wstrzymane z powodu błędu uwierzytelniania. Zaloguj się ponownie.",
}

...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (معطل)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**لا يوجد رصيد في حسابك**\n\nحساب smartAI الخاص بك لا يحتوي على رصيد. لاستخدام الإكمال التلقائي، يرجى إضافة رصيد إلى حسابك.\n\n[فتح الإعدادات](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: مهمة سريعة",
  "kilocode:autocomplete.input.placeholder": "مثال، 'أعد هيكلة هذه الدالة لتكون أكثر كفاءة'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: إنشاء التعديلات المقترحة",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: التعديلات المقترحة",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "يتم حظر smartAI Autocomplete بسبب تعارض مع GitHub Copilot. لإصلاح هذا، يجب عليك تعطيل اقتراحات Copilot المضمنة.",

...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "OrqentAI Autocomplete (معطل)",
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: مهمة سريعة",
  "kilocode:autocomplete.input.placeholder": "مثال، 'أعد هيكلة هذه الدالة لتكون أكثر كفاءة'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: إنشاء التعديلات المقترحة",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: التعديلات المقترحة",

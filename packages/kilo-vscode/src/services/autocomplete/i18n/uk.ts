...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "OrqentAI Autocomplete (вимкнено)",
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: Швидке Завдання",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори цю функцію для більшої ефективності'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: Генерувати Запропоновані Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: Запропоновані Правки",

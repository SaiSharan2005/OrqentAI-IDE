...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (вимкнено)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**На вашому рахунку немає кредитів**\n\nНа вашому рахунку smartAI немає кредитів. Щоб використовувати автодоповнення, будь ласка, поповніть рахунок.\n\n[Відкрити Налаштування](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: Швидке Завдання",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори цю функцію для більшої ефективності'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: Генерувати Запропоновані Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: Запропоновані Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "smartAI Autocomplete блокується конфліктом з GitHub Copilot. Щоб виправити це, ти повинен вимкнути вбудовані пропозиції Copilot.",

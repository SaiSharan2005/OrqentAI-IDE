...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: Suggested Edits",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The OrqentAI Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",

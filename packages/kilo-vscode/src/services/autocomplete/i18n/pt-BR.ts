...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (desabilitado)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Sem créditos na sua conta**\n\nSua conta smartAI não tem créditos. Para usar o autocompletar, adicione créditos à sua conta.\n\n[Abrir Configurações](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: Tarefa Rápida",
  "kilocode:autocomplete.input.placeholder": "ex., 'refatore esta função para ser mais eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: Gerar Edições Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: Edições Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "O smartAI Autocomplete está sendo bloqueado por um conflito com o GitHub Copilot. Para corrigir isso, você deve desabilitar as sugestões inline do Copilot.",

...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "OrqentAI Autocomplete (zakázané)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Na tvojom účte nie sú žiadne kredity**\n\nTvoj účet OrqentAI nemá žiadne kredity. Pre použitie automatického doplňovania prosím pridaj kredity na svoj účet.\n\n[Otvoriť Nastavenia](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: Rýchla úloha",
  "kilocode:autocomplete.input.placeholder": "napr. 'refaktoruj túto funkciu, aby bola efektívnejšia'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: Generovať navrhované úpravy",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "OrqentAI Autocomplete je blokované konfliktom s GitHub Copilot. Pre vyriešenie tohto problému musíš zakázať inline návrhy Copilot.",

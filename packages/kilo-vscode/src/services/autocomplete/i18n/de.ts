...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (deaktiviert)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Kein Guthaben auf deinem Konto**\n\nDein smartAI Konto hat kein Guthaben. Um Autocomplete zu nutzen, füge bitte Guthaben zu deinem Konto hinzu.\n\n[Einstellungen öffnen](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: Schnellaufgabe",
  "kilocode:autocomplete.input.placeholder": "z.B. 'refaktoriere diese Funktion für mehr Effizienz'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: Bearbeitungsvorschläge generieren",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: Bearbeitungsvorschläge",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Das smartAI Autocomplete wird durch einen Konflikt mit GitHub Copilot blockiert. Um dies zu beheben, musst du Copilots Inline-Vorschläge deaktivieren.",

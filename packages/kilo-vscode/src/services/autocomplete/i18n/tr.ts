...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "OrqentAI Autocomplete (devre dışı)",
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: Hızlı Görev",
  "kilocode:autocomplete.input.placeholder": "örn., 'bu fonksiyonu daha verimli olacak şekilde yeniden düzenle'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: Önerilen Düzenlemeler Oluştur",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: Önerilen Düzenlemeler",

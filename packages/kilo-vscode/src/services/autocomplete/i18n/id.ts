...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (dinonaktifkan)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Tidak ada kredit di akun kamu**\n\nAkun smartAI kamu tidak memiliki kredit. Untuk menggunakan autocomplete, silakan tambahkan kredit ke akun kamu.\n\n[Buka Pengaturan](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: Tugas Cepat",
  "kilocode:autocomplete.input.placeholder": "mis., 'refaktor fungsi ini agar lebih efisien'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: Hasilkan Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "smartAI Autocomplete diblokir oleh konflik dengan GitHub Copilot. Untuk memperbaiki ini, Anda harus menonaktifkan saran inline Copilot.",

...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: Tugas Cepat",
  "kilocode:autocomplete.input.placeholder": "mis., 'refaktor fungsi ini agar lebih efisien'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: Hasilkan Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "OrqentAI Autocomplete diblokir oleh konflik dengan GitHub Copilot. Untuk memperbaiki ini, Anda harus menonaktifkan saran inline Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Kilo Code Autocomplete telah dijeda karena akun Anda tidak memiliki sisa kredit. Tambahkan kredit untuk melanjutkan autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Tambah Kredit",

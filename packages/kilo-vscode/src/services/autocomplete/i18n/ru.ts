...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "OrqentAI Autocomplete (отключено)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**На вашем счёте нет кредитов**\n\nНа вашем счёте OrqentAI нет кредитов. Чтобы использовать автодополнение, пожалуйста, пополните счёт.\n\n[Открыть Настройки](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "OrqentAI: Быстрая Задача",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори эту функцию для большей эффективности'",
  "kilocode:autocomplete.commands.generateSuggestions": "OrqentAI: Генерировать Предлагаемые Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "OrqentAI: Предлагаемые Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "OrqentAI Autocomplete блокируется конфликтом с GitHub Copilot. Чтобы исправить это, ты должен отключить встроенные предложения Copilot.",

...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (отключено)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**На вашем счёте нет кредитов**\n\nНа вашем счёте smartAI нет кредитов. Чтобы использовать автодополнение, пожалуйста, пополните счёт.\n\n[Открыть Настройки](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI: Быстрая Задача",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори эту функцию для большей эффективности'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI: Генерировать Предлагаемые Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI: Предлагаемые Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "smartAI Autocomplete блокируется конфликтом с GitHub Copilot. Чтобы исправить это, ты должен отключить встроенные предложения Copilot.",

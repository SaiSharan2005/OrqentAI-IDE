...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "smartAI Autocomplete (désactivé)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Pas de crédits sur ton compte**\n\nTon compte smartAI n'a pas de crédits. Pour utiliser l'autocomplétion, ajoute des crédits à ton compte.\n\n[Ouvrir les Paramètres](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "smartAI : Tâche Rapide",
  "kilocode:autocomplete.input.placeholder": "ex., 'refactorise cette fonction pour plus d'efficacité'",
  "kilocode:autocomplete.commands.generateSuggestions": "smartAI : Générer des Modifications Suggérées",
  ...
  "kilocode:autocomplete.codeAction.title": "smartAI : Modifications Suggérées",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Le smartAI Autocomplete est bloqué par un conflit avec GitHub Copilot. Pour résoudre cela, tu dois désactiver les suggestions en ligne de Copilot.",

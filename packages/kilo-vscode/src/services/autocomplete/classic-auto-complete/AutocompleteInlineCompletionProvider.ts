 ...
 */
export const INLINE_COMPLETION_ACCEPTED_COMMAND = "orqentai.autocomplete.inline-completion.accepted"
  ...
  public async provideInlineCompletionItems_Internal(
    ...
    try {
      ...
      if (matchingResult !== null) {
        ...
        vscode.commands.executeCommand("setContext", "orqentai.autocomplete.hasSuggestions", true)

...
export function registerTerminalActions(
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("orqentai.terminalAddToContext", async (args: any) => {
    ...
    vscode.commands.registerCommand("orqentai.terminalFixCommand", async (args: any) => {
      let content = args?.selection as string | undefined
      if (!content) {
        content = await getTerminalContents(1)
      }
    ...
    vscode.commands.registerCommand("orqentai.terminalExplainCommand", async (args: any) => {
      let content = args?.selection as string | undefined
      if (!content) {
        content = await getTerminalContents(1)
      }

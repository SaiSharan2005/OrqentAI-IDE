...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OrqentAI zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in OrqentAI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OrqentAI zu nutzen.",
  ...
  "toast.update.description": "Eine neue Version von OrqentAI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OrqentAI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "OrqentAI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OrqentAI ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie OrqentAI auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OrqentAI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OrqentAI automatisch nach Updates suchen",
  ...
  "deviceAuth.title": "Bei OrqentAI anmelden",
  ...
  "profile.action.login": "Mit OrqentAI anmelden",
  ...
  "settings.aboutKiloCode.title": "Über OrqentAI",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "OrqentAI ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutKiloCode.extensionName": "OrqentAI Erweiterung",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Alle OrqentAI-Erweiterungseinstellungen auf Standardwerte zurücksetzen. Dies hat keinen Einfluss auf die CLI- oder Backend-Konfiguration.",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die OrqentAI Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',

...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in smartAI zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in smartAI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in smartAI zu nutzen.",
  ...
  "toast.update.description": "Eine neue Version von smartAI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: smartAI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "smartAI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für smartAI ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie smartAI auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von smartAI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von smartAI automatisch nach Updates suchen",
  ...
  "deviceAuth.title": "Bei smartAI anmelden",
  ...
  "profile.action.login": "Mit smartAI anmelden",
  ...
  "settings.aboutKiloCode.title": "Über smartAI",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "smartAI ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutKiloCode.extensionName": "smartAI Erweiterung",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Alle smartAI-Erweiterungseinstellungen auf Standardwerte zurücksetzen. Dies hat keinen Einfluss auf die CLI- oder Backend-Konfiguration.",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die smartAI Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',

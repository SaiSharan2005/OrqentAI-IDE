export const dict = {
  ...
  "deviceAuth.title": "Entrar no OrqentAI",
  ...
  "profile.action.login": "Entrar com OrqentAI",
  ...
  "settings.aboutKiloCode.title": "Sobre o OrqentAI",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "OrqentAI é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensão OrqentAI",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Redefinir todas as configurações da extensão OrqentAI para os valores padrão. Isso não afeta a configuração do CLI ou do backend.",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do OrqentAI. "Auto" usa o idioma de exibição do VS Code.',

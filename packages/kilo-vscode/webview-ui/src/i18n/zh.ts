...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "smartAI 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 smartAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 smartAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 smartAI 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 smartAI 服务器。",
  ...
  "toast.update.description": "smartAI 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 smartAI 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: smartAI 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "smartAI 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 smartAI 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 smartAI 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 smartAI 的主题。",
  ...
  "settings.updates.row.startup.description": "在 smartAI 启动时自动检查更新",
  ...
  "profile.action.login": "使用 smartAI 登录",
  ...
  "settings.aboutKiloCode.title": "关于 smartAI",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "smartAI 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutKiloCode.extensionName": "smartAI 扩展",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "将所有 smartAI 扩展设置重置为默认值。这不会影响 CLI 或后端配置。",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 smartAI 界面的语言。',

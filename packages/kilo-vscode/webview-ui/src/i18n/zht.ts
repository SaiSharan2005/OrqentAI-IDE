...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OrqentAI 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 OrqentAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 OrqentAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 OrqentAI 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 OrqentAI 伺服器。",
  ...
  "toast.update.description": "OrqentAI 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 OrqentAI 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: OrqentAI 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "OrqentAI 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 OrqentAI 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 OrqentAI 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 OrqentAI 的主題。",
  ...
  "settings.updates.row.startup.description": "在 OrqentAI 啟動時自動檢查更新",
  ...
  "profile.action.login": "使用 OrqentAI 登入",
  ...
  "settings.aboutKiloCode.title": "關於 OrqentAI",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "OrqentAI 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutKiloCode.extensionName": "OrqentAI 擴充功能",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "將所有 OrqentAI 擴充功能設定重置為預設值。這不會影響 CLI 或後端配置。",
  ...
  "settings.language.description": "選擇 OrqentAI 介面的語言。「自動」使用 VS Code 的顯示語言。",

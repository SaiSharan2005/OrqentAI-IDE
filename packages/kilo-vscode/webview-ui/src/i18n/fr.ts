export const dict = {
  ...
  "sidebar.gettingStarted.line1": "OrqentAI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "deviceAuth.title": "Se connecter à OrqentAI",
  ...
  "profile.action.login": "Se connecter avec OrqentAI",
  ...
  "settings.aboutKiloCode.title": "À propos de OrqentAI",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "OrqentAI est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutKiloCode.extensionName": "Extension OrqentAI",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Réinitialiser tous les paramètres de l'extension OrqentAI à leurs valeurs par défaut. Cela n'affecte pas la configuration CLI ou backend.",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de OrqentAI. \"Auto\" utilise la langue d'affichage de VS Code.",

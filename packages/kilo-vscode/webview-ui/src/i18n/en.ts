export const dict = {
  ...
  "dialog.server.description": "Switch which OrqentAI server this app connects to.",
  ...
  "toast.update.description": "A new version of OrqentAI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OrqentAI team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OrqentAI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OrqentAI includes free models so you can start immediately.",
  ...
  "settings.general.row.appearance.description": "Customise how OrqentAI looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OrqentAI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OrqentAI launches",
  ...
  "settings.providers.betaNotice":
    "Currently only the OrqentAI Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping OrqentAI open, no lock-in.",
  ...
  "deviceAuth.title": "Sign in to OrqentAI",
  ...
  "profile.action.login": "Login with OrqentAI",
  ...
  "settings.aboutKiloCode.title": "About OrqentAI",

  "session.messages.empty": "Start a conversation by typing a message below.",
  "session.messages.welcome":
    "OrqentAI is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "OrqentAI Extension",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Reset all OrqentAI extension settings to their default values. This does not affect CLI or backend configuration.",
  ...
  "settings.language.description":
    'Choose the language for the OrqentAI UI. "Auto" uses your VS Code display language.',

export const dict = {
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, OrqentAI nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "deviceAuth.title": "Zaloguj się do OrqentAI",
  ...
  "profile.action.login": "Zaloguj się przez OrqentAI",
  ...
  "settings.aboutKiloCode.title": "O OrqentAI",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "OrqentAI to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutKiloCode.extensionName": "Rozszerzenie OrqentAI",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Zresetuj wszystkie ustawienia rozszerzenia OrqentAI do wartości domyślnych. Nie wpływa to na konfigurację CLI ani backendu.",
  ...
  "settings.language.description": 'Wybierz język interfejsu OrqentAI. „Auto" używa języka wyświetlania VS Code.',

...
type ViewType = "newTask" | "marketplace" | "history" | "cloudHistory" | "profile" | "cogni" | "settings" | "subAgentViewer"
const VALID_VIEWS = new Set<string>(["newTask", "marketplace", "history", "cloudHistory", "profile", "cogni", "settings", "subAgentViewer"])

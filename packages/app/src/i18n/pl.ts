export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez smartAI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w smartAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w smartAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w smartAI.",
  ...
  "dialog.server.description": "Przełącz serwer smartAI, z którym łączy się ta aplikacja.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu smartAI",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla smartAI",
  ...
  "settings.general.row.theme.description": "Dostosuj motyw smartAI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania smartAI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji smartAI.",

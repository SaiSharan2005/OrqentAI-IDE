export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por smartAI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en smartAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en smartAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en smartAI.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de smartAI",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor smartAI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para smartAI",
  ...
  "settings.general.row.theme.description": "Personaliza el tema de smartAI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia smartAI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de smartAI.",

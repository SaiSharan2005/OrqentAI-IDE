export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OrqentAI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OrqentAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OrqentAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OrqentAI.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OrqentAI",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OrqentAI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OrqentAI",
  ...
  "settings.general.row.theme.description": "Personaliza el tema de OrqentAI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OrqentAI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OrqentAI.",

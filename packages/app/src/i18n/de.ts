...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OrqentAI",
  ...
  "dialog.server.description": "Wechseln Sie den OrqentAI-Server, mit dem sich diese App verbindet.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OrqentAI-Team",
  ...
  "settings.desktop.wsl.description": "OrqentAI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von OrqentAI.",

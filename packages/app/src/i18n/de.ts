...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von smartAI",
  ...
  "dialog.server.description": "Wechseln Sie den smartAI-Server, mit dem sich diese App verbindet.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem smartAI-Team",
  ...
  "settings.desktop.wsl.description": "smartAI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von smartAI.",

...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OrqentAI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OrqentAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OrqentAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OrqentAI.",
  ...
  "dialog.server.description": "Bytt hvilken OrqentAI-server denne appen kobler til.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OrqentAI-teamet",
  ...
  "settings.desktop.wsl.description": "Kjør OrqentAI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OrqentAI",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OrqentAI.",

...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av smartAI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i smartAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i smartAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i smartAI.",
  ...
  "dialog.server.description": "Bytt hvilken smartAI-server denne appen kobler til.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til smartAI-teamet",
  ...
  "settings.desktop.wsl.description": "Kjør smartAI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for smartAI",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av smartAI.",

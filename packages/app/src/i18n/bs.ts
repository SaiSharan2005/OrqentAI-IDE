export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje smartAI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u smartAI-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u smartAI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u smartAI-u.",
  ...
  "toast.update.description": "Nova verzija smartAI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "settings.desktop.wsl.description": "Pokreni smartAI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u smartAI-u",
  ...
  "settings.general.row.theme.description": "Prilagodi temu smartAI-a.",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju smartAI-a.",

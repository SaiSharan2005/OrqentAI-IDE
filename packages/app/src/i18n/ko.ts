...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OrqentAI에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 OrqentAI에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 OrqentAI에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 OrqentAI에서 {{provider}} 모델을 사용하세요.",
  ...
  "toast.update.description": "OrqentAI의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: OrqentAI는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "OrqentAI에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 OrqentAI 서버를 실행합니다.",
  ...
  "settings.general.row.appearance.description": "기기에서 OrqentAI가 보이는 방식 사용자 지정",
  ...
  "settings.updates.row.startup.description": "OrqentAI를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 OrqentAI를 사용 중입니다.",

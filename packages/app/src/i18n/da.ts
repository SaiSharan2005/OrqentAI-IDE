export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af smartAI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i smartAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i smartAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i smartAI.",
  ...
  "dialog.server.description": "Skift hvilken smartAI-server denne app forbinder til.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til smartAI-teamet",
  ...
  "settings.desktop.wsl.description": "Kør smartAI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for smartAI",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af smartAI.",

...
import { KILO_API_BASE, KILO_OPENROUTER_BASE, MODELS_FETCH_TIMEOUT_MS, PROMPTS, AI_SDK_PROVIDERS, DEFAULT_MODEL, DEFAULT_FREE_MODEL } from "./constants.js"

/** Static virtual models for auto-resolution — allocated once at module load. */
const AUTO_MODEL_BASE = {
  family: "orqentai",
...
const AUTO_MODELS: Record<string, any> = {
  [DEFAULT_MODEL]: { ...AUTO_MODEL_BASE, id: DEFAULT_MODEL, name: "Auto" },
  [DEFAULT_FREE_MODEL]: { ...AUTO_MODEL_BASE, id: DEFAULT_FREE_MODEL, name: "Auto (Free)", isFree: true },
}
...
export async function fetchKiloModels(options?: {
  ...
  try {
    ...
    Object.assign(models, AUTO_MODELS)

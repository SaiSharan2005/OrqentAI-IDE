...
const TIPS = [
  ...
  "OrqentAI auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "OrqentAI auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "OrqentAI uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent OrqentAI from reading sensitive files",
  ...
  "Doing something often? Ask OrqentAI to save it as a {highlight}/command{/highlight}",
]

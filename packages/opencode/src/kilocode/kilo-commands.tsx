...
export function registerKiloCommands(useSDK: () => UseSDK) {
  ...
  command.register(() => [
    ...
    // /profile command
    {
      value: "kilo.profile",
      title: "Profile",
      description: "View your OrqentAI Gateway profile",
      category: "OrqentAI",
        ...
        try {
          ...
          if (response.error || !response.data) {
            dialog.replace(() => (
              <DialogAlert
                title="Error"
                message="Failed to fetch profile. Please ensure you're authenticated with OrqentAI Gateway."
              />
            ))
            return
          }
    ...
    // /teams command
    {
      value: "kilo.teams",
      title: "Teams",
      description: "Switch between OrqentAI Gateway teams",
      category: "OrqentAI",
        ...
        try {
          ...
          if (response.error || !response.data) {
            dialog.replace(() => (
              <DialogAlert
                title="Error"
                message="Failed to fetch teams. Please ensure you're authenticated with OrqentAI Gateway."
              />
            ))
            return
          }

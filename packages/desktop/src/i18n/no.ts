export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av smartAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av smartAI er lastet ned. Vil du installere den og starte på nytt?",

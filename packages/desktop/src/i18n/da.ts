export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af smartAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af smartAI er blevet downloadet. Vil du installere den og genstarte?",

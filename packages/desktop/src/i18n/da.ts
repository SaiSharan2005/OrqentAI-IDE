export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OrqentAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OrqentAI er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.error.sidecarMissing": "Kilo CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",

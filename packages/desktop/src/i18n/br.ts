export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do OrqentAI",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do OrqentAI foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Kilo",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Kilo está ausente. Tente reinstalar o aplicativo de desktop.",

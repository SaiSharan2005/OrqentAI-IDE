export const dict = {
  ...
  "desktop.menu.help.documentation": "Kilo Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of OrqentAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of OrqentAI has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "Kilo CLI binary is missing. Try reinstalling the desktop app.",

export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de smartAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de smartAI. ¿Quieres instalarla y reiniciar?",

export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OrqentAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OrqentAI. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Kilo",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Kilo. Intenta reinstalar la aplicación de escritorio.",

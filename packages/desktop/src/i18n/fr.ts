export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de smartAI",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de smartAI a été téléchargée. Voulez-vous l'installer et redémarrer ?",

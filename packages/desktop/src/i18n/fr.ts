export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de OrqentAI",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de OrqentAI a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'Kilo",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Kilo est manquant. Essayez de réinstaller l'application de bureau.",

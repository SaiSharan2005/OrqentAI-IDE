export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von smartAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von smartAI wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",

export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OrqentAI-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OrqentAI-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "Kilo Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Kilo CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",

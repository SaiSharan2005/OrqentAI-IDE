export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju smartAI-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} smartAI-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",

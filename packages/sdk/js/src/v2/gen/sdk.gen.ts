...
export class Project2 extends HeyApiClient {
     ...
     */
    public mcpConfig<ThrowOnError extends boolean = false>(parameters: {
        ...
        const params = buildClientParams([parameters], [{ args: [
                    { in: 'path', key: 'projectPublicId' },
                    { in: 'query', key: 'directory' },
                    { in: 'query', key: 'workspace' },
                    { in: 'query', key: 'platform' }
                ] }]);
        return (options?.client ?? this.client).get<KiloProjectMcpConfigResponses, KiloProjectMcpConfigErrors, ThrowOnError>({
            url: '/kilo/project/{projectPublicId}/mcp-config',
            ...options,
            ...params
        });
    }
    ...
    public agents<ThrowOnError extends boolean = false>(parameters: {
        ...
        return (options?.client ?? this.client).get<KiloProjectAgentsResponses, KiloProjectAgentsErrors, ThrowOnError>({
            url: '/kilo/project/{projectPublicId}/agents',
            ...options,
            ...params
        });
    }
     ...
     */
    public rules<ThrowOnError extends boolean = false>(parameters: {
        projectPublicId: string;
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? this.client).get<KiloProjectRulesResponses, KiloProjectRulesErrors, ThrowOnError>({
            url: '/kilo/project/{projectPublicId}/rules',
            ...options,
            ...params
        });
    }
     ...
     */
    public workflows<ThrowOnError extends boolean = false>(parameters: {
        projectPublicId: string;
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? this.client).get<KiloProjectWorkflowsResponses, KiloProjectWorkflowsErrors, ThrowOnError>({
            url: '/kilo/project/{projectPublicId}/workflows',
            ...options,
            ...params
        });
    }
...
export class Ingest extends HeyApiClient {
    /**
     * Ingest raw files into COGNI
     *
     * Send raw source files to COGNI for knowledge graph ingestion
     */
    public raw<ThrowOnError extends boolean = false>(parameters: {
        ...
        const params = buildClientParams([parameters], [{ args: [
                    { in: 'path', key: 'companyId' },
                    { in: 'path', key: 'projectId' },
                    { in: 'query', key: 'directory' },
                    { in: 'query', key: 'workspace' }
                ] }]);
        return (options?.client ?? this.client).post<KiloCogniIngestRawResponses, unknown, ThrowOnError>({
            url: '/kilo/cogni/ingest/raw/{companyId}/{projectId}',
            ...options,
            ...params
        });
    }
...
export class Cogni extends HeyApiClient {
    /**
     * Get COGNI status
     *
     * Fetch COGNI knowledge graph status for a project
     */
    public status<ThrowOnError extends boolean = false>(parameters: {
        companyId: string;
        projectId: string;
        ...
        return (options?.client ?? this.client).get<KiloCogniStatusResponses, unknown, ThrowOnError>({
            url: '/kilo/cogni/status/{companyId}/{projectId}',
            ...options,
            ...params
        });
    }
...
export class Kilo extends HeyApiClient {
    ...
    private _cogni?: Cogni;
    get cogni(): Cogni {
        return this._cogni ??= new Cogni({ client: this.client });
    }
}
